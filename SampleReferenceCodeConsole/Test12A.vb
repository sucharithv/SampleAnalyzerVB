...
Public Class Test12A
    Sub EvaluatedHasValueFirstConstantFirst()
        Dim budgetEligibilityBO As BudgetEligibilityBO = Nothing
        WriteLog("budgetEligibilityBO.ProcessCode.HasValue AndAlso ProcessCodes.NonContinuousEligibility <> budgetEligibilityBO.ProcessCode...")
        If budgetEligibilityBO.ProcessCode.HasValue AndAlso
            ProcessCodes.NonContinuousEligibility <> budgetEligibilityBO.ProcessCode Then

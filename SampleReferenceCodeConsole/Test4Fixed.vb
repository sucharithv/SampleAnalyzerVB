...
Public Class Test4Fixed
    Private items As System.Collections.Generic.List(Of Integer) = Nothing

    Public Sub SimpleCode()
        Dim record As Foo = Nothing
        If record?.EffectiveBeginDate.HasValue AndAlso record?.EffectiveBeginDate <> System.DateTime.MaxValue AndAlso record?.EffectiveBeginDate <> System.DateTime.MinValue Then
        End If
    End Sub
